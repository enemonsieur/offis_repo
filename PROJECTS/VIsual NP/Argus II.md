...
=> Usually the best is 2-3ms SBiphasid pulse. This create a current around 50nC for each phase which is bearable for the cells. The best ISI IPI that helps still recon
